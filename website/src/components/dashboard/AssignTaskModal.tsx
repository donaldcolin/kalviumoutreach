  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
        ...
        <p className="text-sm text-gray-500 mb-6">Assigning to {selectedAssociate.name}</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Popover>
              <PopoverTrigger
                className="w-full flex items-center justify-between px-3 py-2 border border-gray-200 rounded-lg text-left focus:outline-none focus:ring-2 focus:ring-gray-900 hover:bg-gray-50 transition-colors"
              >
